...
public interface TrueWayPlacesService {
    ...
    @GET("FindPlacesNearby")//Map<List<Object>,List<Object>>
    Call<Gist> findPlacesNearby(@QueryMap HashMap<String,String> filters,@Query("radius")int radius,@Query("language") String language);
